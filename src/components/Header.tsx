...
export const Header: React.FC = () => {
  ...
  const currentMeta = {
    ...roleMeta[currentRole] || roleMeta.patient,
    portalTitle: t.header.portalTitles[currentRole] || t.header.portalTitles.patient,
    tier: t.header.tiers[currentRole] || t.header.tiers.patient
  };
            ...
            >
              {isOffline ? (
                <>
                  ...
                  <span className="text-amber-300 font-medium">{t.header.offline} ({pendingOfflineSyncCount})</span>
                ...
                <>
                  ...
                  <span className="text-emerald-300 font-medium">{t.header.liveSynced}</span>
                </>
              )}
            </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2.5 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-2.5">
            ...
            >
              ...
              <span className="hidden sm:inline">{t.header.switchPortal}</span>
              <span className="sm:hidden">{t.header.exit}</span>
            </button>
          </div>
        </div>
